...
public class SensitiveWordFilter {
	 ...
	 * 构造函数，初始化敏感词库
	 */
	public void init(Set<String> badWords){
		sensitiveWordMap = new SensitiveWordInit().initKeyWord(badWords);
	}
	...
	public static void main(String[] args) {
		...
		Set<String> badWordAll = new HashSet<>();
		for (BadWordTemplate aBadWord : badWordTemplates) {
			badWordAll.add(aBadWord.getName());
		}
		SensitiveWordFilter filter = SensitiveWordFilter.getInstance();
		filter.init(badWordAll);
		System.out.println("敏感词的数量：" + filter.sensitiveWordMap.size());
		String string = "生孩子沒屁眼";
	...
	public boolean hashBadWords(String content) {
		return isContaintSensitiveWord(content, minMatchTYpe);
	}
}
