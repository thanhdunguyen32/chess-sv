...
public class CBoxTemplateCache implements Reloadable {

    private static Logger logger = LoggerFactory.getLogger(CBoxTemplateCache.class);

    static class SingletonHolder {
        static CBoxTemplateCache instance = new CBoxTemplateCache();
    }

    public static CBoxTemplateCache getInstance() {
    ...
    public void reload() {
        try {
            String fileName = CBoxTemplate.class.getAnnotation(ExcelTemplateAnn.class).file();
    ...
    public CBoxTemplate getCBoxTemplate(int gsid){
        return templateMap.get(gsid);
    }

    public static void main(String[] args) {
        new CBoxTemplateCache().reload();
    }
