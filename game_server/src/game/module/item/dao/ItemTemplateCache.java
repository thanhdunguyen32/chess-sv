...
public class ItemTemplateCache implements Reloadable {
    ...
    public void reload() {
        try {
            ...
            Map<Integer, ItemTemplate> templateWrapperMap = JacksonUtils.getInstance().readValue(jsonStr, new TypeReference<Map<Integer, ItemTemplate>>() {
            });
            logger.info("size={}", templateWrapperMap.size());
            for(Map.Entry<Integer,ItemTemplate> itemPair : templateWrapperMap.entrySet()){
