/*
 ...
 Source Host           : 47.103.137.138:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2562 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '调度日志表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_log`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1026 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_login_log`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 96 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 186 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_menu
-- ----------------------------
INSERT INTO `t_menu` VALUES (1, 0, '系统管理', '', '', 'layui-icon-setting', '0', 3, '2017-12-27 16:39:07', '2019-11-01 15:44:45');
INSERT INTO `t_menu` VALUES (2, 0, '系统监控', '', '', 'layui-icon-alert', '0', 4, '2017-12-27 16:45:51', '2019-11-01 15:44:41');
...
INSERT INTO `t_menu` VALUES (115, 0, '其他模块', '', '', 'layui-icon-gift', '0', 6, '2019-05-27 10:18:07', '2019-11-01 15:44:30');
...
INSERT INTO `t_menu` VALUES (137, 0, '代码生成', '', '', 'layui-icon-verticalright', '0', 5, '2019-06-03 15:35:58', '2019-11-01 15:44:36');
...
INSERT INTO `t_menu` VALUES (178, 0, '运营查询', '', '', 'layui-icon-linechart', '0', 1, '2019-11-01 15:43:54', NULL);
INSERT INTO `t_menu` VALUES (179, 0, '操作', '', '', 'layui-icon-edit-square', '0', 2, '2019-11-01 15:45:52', NULL);
INSERT INTO `t_menu` VALUES (180, 178, '实时统计', '/query/active', 'active:view', 'layui-icon-check-circle', '0', 1, '2019-11-01 15:47:51', '2019-11-01 15:47:58');
INSERT INTO `t_menu` VALUES (181, 178, '历史记录', '/query/history', 'history:view', 'layui-icon-reloadtime', '0', 2, '2019-11-01 15:48:42', NULL);
INSERT INTO `t_menu` VALUES (182, 179, '活动配置', '/op/activity', 'activity:view', 'layui-icon-wrench', '0', 1, '2019-11-01 15:49:58', NULL);
INSERT INTO `t_menu` VALUES (183, 179, '封号', '/op/fenghao', 'fenghao:view', 'layui-icon-scissor', '0', 2, '2019-11-01 15:50:34', NULL);
INSERT INTO `t_menu` VALUES (184, 182, '新增活动', NULL, 'activity:add', NULL, '1', NULL, '2019-11-01 16:09:02', NULL);
INSERT INTO `t_menu` VALUES (185, 182, '修改活动', NULL, 'activity:add', NULL, '1', NULL, '2019-11-01 16:09:40', NULL);
INSERT INTO `t_menu` VALUES (203, 179, 'Gói nạp', '/op/recharge', 'recharge:view', 'layui-icon-rmb', '0', 3, '2024-01-01 00:00:00', NULL);
INSERT INTO `t_menu` VALUES (204, 203, 'Thêm gói', NULL, 'recharge:add', NULL, '1', NULL, '2024-01-01 00:00:00', NULL);
INSERT INTO `t_menu` VALUES (205, 203, 'Sửa gói', NULL, 'recharge:update', NULL, '1', NULL, '2024-01-01 00:00:00', NULL);
INSERT INTO `t_menu` VALUES (206, 203, 'Xóa gói', NULL, 'recharge:delete', NULL, '1', NULL, '2024-01-01 00:00:00', NULL);
...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role` VALUES (1, '系统管理员', '系统管理员，拥有所有操作权限 ^_^', '2019-06-14 16:23:11', '2019-11-01 16:10:17');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'MrBird', 'a4f18ee51f21294dc3ae8b7c5642035a', 1, 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2019-11-01 10:49:06', '2019-11-01 17:24:33', '0', '0', 'black', '1d22f3e41d284f50b2c8fc32e0788698.jpeg', '我是帅比作者。');
INSERT INTO `t_user` VALUES (2, 'Scott', '1d685729d113cfd03872f154939bee1c', 10, 'scott@gmail.com', '17722222222', '1', '2019-06-14 20:55:53', '2019-06-14 21:05:43', '2019-10-31 22:05:35', '0', '1', 'black', 'gaOngJwsRYRaVAuXXcmB.png', '我是scott。');
...
INSERT INTO `t_user` VALUES (4, 'Micaela', '9f2daa2c7bed6870fcbb5b9a51d6300e', 10, 'Micaela@163.com', '17733333333', '1', '2019-06-14 21:10:13', '2019-06-14 21:11:26', '2019-10-31 22:16:40', '0', '0', 'white', '20180414165909.jpg', '我叫米克拉');
