...
public class GlobalExceptionHandler {
    ...
    public FebsResponse handleException(Exception e) {
        log.error("Ngoại lệ nội bộ hệ thống, thông tin ngoại lệ", e);
        return new FebsResponse().code(HttpStatus.INTERNAL_SERVER_ERROR).message("Ngoại lệ nội bộ của hệ thống");
    }
