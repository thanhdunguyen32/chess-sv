...
layui
    ...
    .define(
        ...
        function (exports) {
            ...
            self.loadHtml = function (url, callback) {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        if (result.code === 401) {
                            self.notify('Đăng nhập không hợp lệ', 'Đăng nhập đã hết hạn, vui lòng đăng nhập lại', function () {
            ...
            //Phân tích các tập tin thông thường
