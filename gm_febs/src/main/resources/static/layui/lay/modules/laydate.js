...
! function() {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function() {
        ...
        t.elem = w(t.elem), t.eventElem = w(t.eventElem), t.elem[0] && (t.range === !0 && (t.range = "-"), t.format === i.date && (t.format = i[t.type]), e.format = t.format.match(new RegExp(n + "|.", "g")) || [], e.EXP_IF = "", e.EXP_SPLIT = "", w.each(e.format, function(t, a) {
            ...
            "0-1-1": "Tết Dương lịch",
            "0-2-14": "Lễ Tình nhân",
            "0-3-8": "Ngày Quốc tế Phụ nữ",
            "0-3-12": "Ngày Trồng cây",
            "0-4-1": "Ngày Cá tháng Tư",
            "0-5-1": "Ngày Quốc tế Lao động",
            "0-5-4": "Ngày Thanh niên",
            "0-6-1": "Ngày Quốc tế Thiếu nhi",
            "0-9-10": "Ngày Nhà giáo",
            "0-9-18": "Ngày Quốc sỉ (Nhớ lại Quốc nhục)",
            "0-10-1": "Ngày Quốc khánh",
            "0-12-25": "Lễ Giáng sinh"
        ...
        return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = w.extend({}, i.startDate), w.each([i.startDate, i.endDate], function(e, t) {
            m(t, l[e], e)
        })) : m(o, l) : (i.hint("Định dạng ngày là bất hợp pháp<br>Phải tuân theo định dạng sau: <br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>已为你重置"), a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse()), e && e(), i)
