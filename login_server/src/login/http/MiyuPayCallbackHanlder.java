...
//
//public class MiyuPayCallbackHanlder extends AbstractHandler {
//
//	public static final Logger logger = LoggerFactory.getLogger(MiyuPayCallbackHanlder.class);
//
//	static class SingletonHolder {
//		static MiyuPayCallbackHanlder instance = new MiyuPayCallbackHanlder();
//	}
//
//	public static MiyuPayCallbackHanlder getInstance() {
...
//		String game_id = paramMap.get("game_id");
//		String out_trade_no = paramMap.get("out_trade_no");
//		String price = paramMap.get("price");
//		String extra_param = paramMap.get("extend");
//		String responseStr = "0";
//		try {
//			// 验签
//			String payKey = "DZQ!@#9527";
//			String sourceStr = game_id + out_trade_no + price + extra_param;
//			logger.info("miyu verify,source={},sign={}", sourceStr, signStr);
//			String mySign = DigestUtils.md5Hex(sourceStr + payKey);
//			if (!signStr.equalsIgnoreCase(mySign)) {
//				responseStr = "0";
//			} else {
//				responseStr = "1";
//				int money = Float.valueOf(price).intValue();// moneu以元为单位
//				money *= 100;
//				// 参数解压
