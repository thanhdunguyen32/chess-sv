...
//
//public class SifubaRoleQueryJettyHanlder extends AbstractHandler {
//
//	public static final Logger logger = LoggerFactory.getLogger(SifubaRoleQueryJettyHanlder.class);
//
//	static class SingletonHolder {
//		static SifubaRoleQueryJettyHanlder instance = new SifubaRoleQueryJettyHanlder();
//	}
//
//	public static SifubaRoleQueryJettyHanlder getInstance() {
...
//		logger.info("sifuba role query,request params={}", queryStr);
...
//				RequestMessage requestMessage = GsSyncRequest.getInstance().getRetMsg();
//				int roleid = requestMessage.getInt();
//				String rolename = requestMessage.getString();
//				if (roleid > 0) {
