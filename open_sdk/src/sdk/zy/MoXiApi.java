...
public class MoXiApi {

	private static Logger logger = LoggerFactory.getLogger(MoXiApi.class);

	static class SingletonHolder {
		static MoXiApi instance = new MoXiApi();
	}

	public static MoXiApi getInstance() {
		return SingletonHolder.instance;
	}

	public Map<String, Object> verifylogin(String appid, String accountId,String tokenKey,String requestUrl) {
		String requestParams = String.format("appid=%1$s&account=%2$s&token=%3$s", appid, accountId, tokenKey);
