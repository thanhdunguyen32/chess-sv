 ...
 *
 */
public class PingPingApi {

	private static Logger logger = LoggerFactory.getLogger(PingPingApi.class);

	static class SingletonHolder {
		static PingPingApi instance = new PingPingApi();
	}

	public static PingPingApi getInstance() {
		return SingletonHolder.instance;
	}

	public Map<String, Object> verifylogin(String game_id,String user_code,String login_token,String requestUrl,String gameKey) {
		String keySource = game_id+user_code+login_token+gameKey;
		String signStr = DigestUtils.md5Hex(keySource);
		String requestParams = String.format("{\"GameId\":\"%1$s\",\"UserCode\":\"%2$s\",\"LoginToken\":\"%3$s\",\"Sign\":\"%4$s\"}",game_id, user_code,login_token,signStr);
