...
public class QuickApi {
	...
	static class SingletonHolder {
		static QuickApi instance = new QuickApi();
	}
	...
	public String verifylogin(String token, String product_code, String uid, String requestUrl) {
		// 生成sign
		String requestParams = String.format("token=%1$s&product_code=%2$s&uid=%3$s", token, product_code,
				uid);
