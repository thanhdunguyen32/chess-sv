...
public class Xiao7Api {

	private static Logger logger = LoggerFactory.getLogger(Xiao7Api.class);

	static class SingletonHolder {
		static Xiao7Api instance = new Xiao7Api();
	}

	public static Xiao7Api getInstance() {
		return SingletonHolder.instance;
	}

	public Map<String, Object> verifylogin(String appkey, String tokenkey, String requestUrl) {
		// 生成sign
		try {
			String mySighStr = DigestUtils.md5Hex(appkey + tokenkey);
			String requestParams = String.format("tokenkey=%1$s&sign=%2$s", URLEncoder.encode(tokenkey, "UTF-8"),
					URLEncoder.encode(mySighStr, "UTF-8"));
	...
	public static void main(String[] args) {
		...
		try {
			Map<String, Object> retMap = Xiao7Api.getInstance().getOrderId("18", 1, "diamond001", "diamond001", 600, 5,
