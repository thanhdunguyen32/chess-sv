...
public class XingTengApi {

	private static Logger logger = LoggerFactory.getLogger(XingTengApi.class);

	static class SingletonHolder {
		static XingTengApi instance = new XingTengApi();
	}

	public static XingTengApi getInstance() {
		return SingletonHolder.instance;
	}

	public String verifylogin(String app, String uin, String tokenStr, Long ts, String requestUrl,String appKey) {
		// 生成sign
		String requestParams = String.format("app=%1$s&token=%2$s&ts=%3$d&uin=%4$s", app,tokenStr,ts,uin);
		String signStr = DigestUtils.md5Hex(requestParams+appKey);
		String retMap = doHttpPost(requestUrl, requestParams+"&sign="+signStr);
		return retMap;
	}

	private String doHttpGet(String requestUrlPath, String requestParams) {
		String result = "";
	...
	private String doHttpPost(String requestUrl, String requestParams) {
		String result = "";
		BufferedReader in = null;
