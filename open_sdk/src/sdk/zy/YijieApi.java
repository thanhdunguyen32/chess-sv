...
public class YijieApi {

	private static Logger logger = LoggerFactory.getLogger(YijieApi.class);

	static class SingletonHolder {
		static YijieApi instance = new YijieApi();
	}

	public static YijieApi getInstance() {
		return SingletonHolder.instance;
	}

	public String verifylogin(String sdk, String app, String uin, String sess, String requestUrl) {
		// 生成sign
		try {
			String requestParams = String.format("sdk=%1$s&app=%2$s&uin=%3$s&sess=%4$s", sdk, app,
					URLEncoder.encode(uin, "UTF-8"), URLEncoder.encode(sess, "UTF-8"));
			String retMap = doHttpGet(requestUrl, requestParams);
			return retMap;
