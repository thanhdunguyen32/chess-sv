 ...
 */
public abstract class HttpPostByteHandler extends HttpSyncHandler {

    public HttpPostByteHandler(String name) {
        super(name);
    }
    ...
    public abstract String strHttpHandle(ChannelHandlerContext ctx, FullHttpRequest request, ByteBuf content) throws Exception;
    ...
    public ByteBuf getContent(FullHttpRequest request) {
