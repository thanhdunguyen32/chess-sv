 ...
 */
public abstract class HttpPostMapHandler extends HttpSyncHandler {

    public HttpPostMapHandler(String name) {
        super(name);
    }
    ...
    public abstract String strHttpHandle(ChannelHandlerContext ctx, FullHttpRequest request, Map<String, String> content) throws Exception;
    ...
    public Map<String, String> getContent(FullHttpRequest request) {
