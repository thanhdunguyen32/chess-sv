 ...
 *                  new {@link ProtobufMsgCodeDecoder}(MyMessage.getDefaultInstance()));
 * 
 * // Encoder
 ...
 */
@Sharable
public class ProtobufMsgCodeDecoder extends MessageToMessageDecoder<ByteBuf> {
	...
	protected void decode(ChannelHandlerContext ctx, ByteBuf msg, List<Object> out) throws Exception {
		...
		out.add(new RequestProtoMessage(msgCode, array, offset + msgCodeLength, length - msgCodeLength));
	}
