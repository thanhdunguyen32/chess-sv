...
public final class WsMessageBase{
	...
	public static final class ServerListItem{
		...
		public int status;
        public int port_ssl;
        public String url_ssl;
        public Boolean is_ssl;
		public ServerListItem(int pid,String pname,String pip_addr,int pport,int pstatus,int pport_ssl, String purl_ssl, Boolean pis_ssl){
			this.id=pid;
			this.name=pname;
            ...
            this.url_ssl = purl_ssl;
            this.is_ssl = pis_ssl;
		}
		public ServerListItem(){}
		@Override
		public String toString() {
			return "ServerListItem [id="+id+",name="+name+",ip_addr="+ip_addr+",port="+port+",status="+status+",port_ssl="+port_ssl+",url_ssl="+url_ssl+",is_ssl="+is_ssl+",]";
		}
	}
